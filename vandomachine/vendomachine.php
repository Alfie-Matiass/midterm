...
<form method = "get">
 <fieldset class="fieldset">
  ...
  <input type="checkbox" name="sodas[]" id="sodasCoke" value = "Coke" > <label for = "sodasCoke">Coke - ₱18</label><br>
  <input type="checkbox" name="sodas[]" id="sodasSprite" value = "Sprite"> <label for = "sodasSprite">Sprite - ₱19</label><br>
  <input type="checkbox" name="sodas[]" id="sodasRoyal" value = "Royal"> <label for = "sodasRoyal">Royal - ₱25</label><br>
  <input type="checkbox" name="sodas[]" id="sodasPepsi" value = "Pepsi"> <label for = "sodasPepsi">Pepsi - ₱20</label><br>
  <input type="checkbox" name="sodas[]" id="sodasMountaindew" value = "Mountaindew"> <label for = "sodasMountaindew">Mountain Dew - ₱30</label><br>
...
<select name="size[]" id="sizes">
  ...
  <option value="UpSize">Up-Size (add ₱10)</option>
  <option value="Jumbo">Jumbo (add ₱15)</option>
</select>

<label for="QtySoda"> Quantity: </label>
<input type="number" name="QtySoda" id="QtySoda" min="1" max="999">
